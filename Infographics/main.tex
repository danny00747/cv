...
\begin{tabular*}{1\textwidth}{ c c c}
	...
	\icontext{MapMarker}{12}{Brussels, Belgium}\\
	\icontext{MobilePhone}{12}{+32 476 *** *** **}\\
    \icontext{Twitter}{12}{@danny}\\
	}&
	\parbox{0.3\textwidth}{
	\icontext{MousePointer}{12}{www.daniel.com}\\
	\icontext{Github}{12}{github.com/danny00747}\\
	\icontext{At}{12}{olvdanny@protonmail.com}\\
	}
\end{tabular*}
...
%----------------------------------------------------------------------------------------
	...
	\mbox{
		...
		\textcolor{textcol}{I am a web developer graduate with working experience in research projects as well as in the private sector.}
		}
		\hspace{10pt}
		\parbox[c][3.9cm][c]{0.32\textwidth}{
			\begin{center}
			\factbubble{\medium{\textcolor{sectcol}{\textbf{\begin{center}\includegraphics[width=2cm, height=1.5cm]{ephec.png}\end{center}}}}\\\small{\textcolor{sectcol}{\textbf{}}}}{1}{maincol}{sectcol}{thirdcol}\\
			\textcolor{textcol}{as latest degree from}\\
			\textcolor{textcol}{\textbf{EPHEC Louvain-La-Neuve}}
			\end{center}
		}
		\hspace{10pt}
		\parbox[c][3cm][c]{0.29\textwidth}{
...
%----------------------------------------------------------------------------------------
	...
	\mbox{
		...
		\parbox[b][150pt][c]{0.35\textwidth}{
			...
			\icontext{Language}{12}{\colorbox{maincol}{French }}\\
            \icontext{Language}{12}{\colorbox{maincol}{Dutch (rudimentary)}}\\
		}

		% PIE CHART	
		\begin{piechart}{360}{2}{bgcol}{textcol}{sectcol}
			\slice{5}{Database}{thirdcol}
			\slice{40}{Backend}{fourthcol}
			\slice{25}{Frontend}{fifthcol}
			\slice{20}{Docker}{secondcol}
			\slice{10}{Cloud}{maincol}
		\end{piechart}\\
	}
	\begin{center}
	\begin{tikzpicture}
	...
	\mbox{\hspace{-14pt}
		\begin{barchart}{10}{5.5}{sectcol}{textcol}{sectcol}{maincol}{secondcol}{thirdcol}
		    \baritem{50}{Java}{0}{0}{70}
			\baritem{80}{Javascript}{0}{0}{90}
            \baritem{80}{C}{0}{0}{65}
			\baritem{50}{Angluar}{0}{0}{75}
			\baritem{80}{Docker}{0}{0}{70}
			\baritem{50}{Linux}{0}{0}{80}
			\baritem{50}{AWS}{0}{0}{40}
		\end{barchart}
		\hspace{10pt}

		% TEXTBOX
		\parbox[b][100pt][c]{0.3\textwidth}{\textcolor{textcol}{Currently, I develop realtime apps with Java and react.\\Formerly I worked with NodeJs and Angular.}}
	}
	\begin{center}
	\begin{tikzpicture}
		\draw[draw=sectcol,dashed, opacity=0.5] (4,0) -- (-4,0);
	...
	\mbox{
		\parbox[b][2cm][c]{3cm}{
			\textcolor{textcol}{I am using Git and IntelliJ IDEA regularly for my dev projects.}
		}\hspace{12pt}
...
%----------------------------------------------------------------------------------------
	...
	\mbox{
		...
		% SQUARE BARS
		\squares{20/Game Dev,20/Fitness,30/Reddit,20/Stackoverflow}{1}
	}
\end{minipage}
...
\cvevent{1/2009}{11/2011}{Belgian Cloud Summit}{EPHEC}{}{thirdcol}{0}
...
\cvevent{9/2016}{12/2016}{Software Engineer}{University of Bremen}
 ...
 \cvevent{02/2017}{02/2017}{FOSDEM}{University of Bremen}
    {text a}{secondcol}{1}
    
\cvevent{11/2017}{11/2017}{Devoxx Belgium}{University of Bremen}
    {text a}{secondcol}{1}
